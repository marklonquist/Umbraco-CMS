...
using Umbraco.Cms.Persistence.Postgresql.Dtos;
...
namespace Umbraco.Cms.Persistence.Postgresql.Services
{
    ...
    public class SyntaxProvider : SqlSyntaxProviderBase<SyntaxProvider>
    {
        ...
        {
            public ServerVersionInfo() => ProductVersionName = VersionName.Unknown;

            public ServerVersionInfo(string edition, string instanceName, string productVersion, string machineName, string productLevel)
            {
                Edition = edition;
        ...
        private static VersionName MapProductVersion(string productVersion)
        {
            ...
            switch (firstPart)
            {
                ...
                case "14":
                    return VersionName.V14;
                case "13":
                    return VersionName.V13;
                case "12":
                    return VersionName.V12;
                case "11":
                    return VersionName.V11;
                case "10":
                    return VersionName.V10;
                default:
                    return VersionName.Invalid;
            }
        }
